...
import {
  ...
  type IncomeAccountItem,
  type IncomeAccountFilters,
} from "@entities/income-account";
import { IncomeAccountsFilters } from "@widgets/income-accounts-filters";
import {
  CreateIncomeAccountButton,
  EditIncomeAccountDrawer,
} from "@widgets/create-income-account";
...
export const IncomeAccountsPage = () => {
  ...
  const handleDelete = async () => {
    ...
    await deleteIncomeAccount(deleteItem.id).unwrap();
    setDeleteItem(null);
    refetch();
  };
